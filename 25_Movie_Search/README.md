...
A modern movie search application that demonstrates API integration with TMDB (The Movie Database) API. Features include movie search, search history, pagination, detailed modal views, and a beautiful responsive UI with dark mode support.
...
- Movie posters, ratings, and release dates
...
- **Beautiful Cards**: Card-based layout for movies
...
- **Result Count**: Shows current page results and total count
...
- Result range display (e.g., "Showing 1-10 of 150 movies")
