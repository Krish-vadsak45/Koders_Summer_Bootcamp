...
import ImageSliderNavigation, { ImageSliderNavDirection, ImageSliderNavStyle } from '@/components/ImageSliderNavigation';
import ImageSliderBullets from '@/components/ImageSliderBullets';
import useSlideIndex from '@/lib/hooks/useSlideIndex';
